...
==================================================
First level workflow for UM GE 750 GLM1 task data

- Model GLM1
  - Use FSL ROI to recreate EPI data, removing last 3 volumes
  - Removed last 3 trials before EV creation
  - EV directory (Model GLM1) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/model_GLM1
- python GLM1_lvl1.py -s WMAZE_001
                       -o /home/data/madlab/data/mri/frstlvl/model_GLM1
                       -w /home/data/madlab/scripts/model_GLM1/status/lvl1
...
def subjectinfo(subject_id):
    ...
    for curr_run in range(1,7):
        ...
        data_all_before_B_corr = np.genfromtxt(base_proj_dir + '/{0}/model_GLM1/run{1}_all_before_B_corr.txt'.format(subject_id,curr_run),dtype = str)
        data_all_before_B_incorr = np.genfromtxt(base_proj_dir + '/{0}/model_GLM1/run{1}_all_before_B_incorr.txt'.format(subject_id,curr_run), dtype = str)
        data_all_remaining = np.genfromtxt(base_proj_dir + '/{0}/model_GLM1/run{1}_all_remaining.txt'.format(subject_id,curr_run),dtype = str)        
...
if __name__ == "__main__":
    ...
    wf.config['execution']['crashdump_dir'] = '/scratch/madlab/crash/mandy_crash/model_GLM1/'
