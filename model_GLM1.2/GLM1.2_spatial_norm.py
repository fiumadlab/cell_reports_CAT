...
"""
=====================================================
GLM1.2_fMRI: Fixed before Conditional -- Model GLM1.2
=====================================================
...
- Model_GLM1.2 
  ...
  - Use FSL ROI to recreate EPI data, removing last 3 volumes
    ...
    - EV directory (Model_GLM1.2) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/model_GLM1.2


- python GLM1.2_norm_stats.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/norm_stats/model_GLM1.2
                         -w /scratch/madlab/crash/model_GLM1.2/norm_stats
"""
...
work_dir = '/scratch/madlab/crash/model_GLM1.2/model_GLM1.2/norm_stats'
sink_dir = '/home/data/madlab/data/mri/wmaze/norm_stats/model_GLM1.2'
...
#datasource node to acquire files
...
datasource_norm.inputs.field_template = dict(copes = 'scndlvl/model_GLM1.2/%s/fixedfx/cope*.nii.gz',
                                             varcopes = 'scndlvl/model_GLM1.2/%s/fixedfx/varcope*.nii.gz',
