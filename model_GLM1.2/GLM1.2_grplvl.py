...
- Model_GLM1.2 
  ...
  - Only includes correct fixed before conditional trials
  - EV directory (Model_GLM1.2) --- /home/data/madlab/data/mri/wmaze/scanner_behav/WMAZE_001/model_GLM1.2


- python GLM1.2_grplvl.py -s WMAZE_001
                         -o /home/data/madlab/data/mri/wmaze/grp_lvl/model_GLM1.2
                         -w /scratch/madlab/crash/model_GLM1.2
...
work_dir = '/scratch/madlab/wmaze/grplvl/model_GLM1.2/'
...
datasource.inputs.field_template = dict(copes = 'norm_stats/model_GLM1.2/%s/norm_copes/cope_%s_trans.nii.gz',
                                        varcopes = 'norm_stats/model_GLM1.2/%s/norm_varcopes/varcope_%s_trans.nii.gz')
